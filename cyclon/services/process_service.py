...
class ProcessService:
    ...
    def __init__(self) -> None:
        ...
        self.current_pty: Optional[PtyProcessUnicode] = None
        self.should_stop_processing = False
        self._terminal_widget: Optional[Any] = None
        self._write_callback: Optional[Callable[[str], None]] = None
        self._pty_changed_callback: Optional[Callable[[], None]] = None
    ...
    async def run_provider_process(self, command: List[str], timeout: int, 
                                  output_callback: Optional[Callable[[str], None]] = None) -> Tuple[int, str]:
        ...
        try:
            ...
            error_msg = "[red]Provider command not found. Ensure provider is installed and in PATH.[/red]\n"
            if output_callback:
    ...
    def write_to_process(self, text: str) -> None:
        ...
        if self.current_pty and self.current_pty.isalive() and text:
            try:
                ...
                raise ProcessError(f"Error writing to process: {e}")
